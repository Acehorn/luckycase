...
class ListaNumeros extends StatefulWidget {
  ListaNumeros({Key key}) : super(key: key);

  @override
  _ListaNumerosState createState() => _ListaNumerosState();
}

class _ListaNumerosState extends State<ListaNumeros> {
  List<String> listNum = [];
